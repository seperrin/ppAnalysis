...
int PeripheralLowBound = 6;
int PeripheralHighBound = 12;

double PtBins[] = {0,3,6,9,12};
...
//    double MaxMultPeriph = 23;
  ...
  // Char_t *arrayOfPeriods[] = {"Group1_LHC16h"};
    ...
    sprintf(FitFileName,"~/../../Volumes/Transcend2/ppAnalysis/Scripts/Run2_0-5_30-100_pt0-3-6-9-12.root");
    sprintf(FolderName,"~/Desktop/Images JavierAnalysis/2021 mars/PlotFromTreePtBinned/Run2_0-5_30-100_pt0-3-6-9-12");
