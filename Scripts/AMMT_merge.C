void AMMT_merge(const char *dir, Int_t stage=0)
{
...
// Analysis source to be compiled at runtime (if any)
   gROOT->ProcessLine(".L AliAnalysisTaskMyMuonTree_AOD.cxx+g");
...
// Set temporary compilation directory to current one
   ...
   TString outputFiles = "EventStat_temp.root,AnalysisResults.root,muonGrid.root";
   ...
   TString outputFile;
   Bool_t merged = kTRUE;
   AliAnalysisManager *mgr = AliAnalysisAlien::LoadAnalysisManager("AMMT.root");
   if (!mgr) {
